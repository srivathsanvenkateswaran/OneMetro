    ...
    lines: [
        ...
        },
        {
            ...
            stations: [
                ...
                { id: 'm11_02', name: 'Anik Bus Depot', nameLocal: 'अणिक बस आगार', type: 'elevated', isInterchange: false, interchangeWith: [], landmark: '', zone: 1 },
                { id: 'm11_03', name: 'CGS Colony', nameLocal: 'सीजीएस कॉलनी', type: 'elevated', isInterchange: false, interchangeWith: [], landmark: '', zone: 1 },
                { id: 'm11_04', name: 'Ganesh Nagar', nameLocal: 'गणेश नगर', type: 'elevated', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_05', name: 'BPT Hospital', nameLocal: 'बीपीटी रुग्णालय', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_06', name: 'Sewri', nameLocal: 'शिवडी', type: 'underground', isInterchange: true, interchangeWith: ['rail'], landmark: '', zone: 4 },
                { id: 'm11_07', name: 'Hay Bunder', nameLocal: 'हे बंदर', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_08', name: 'Coal Bunder', nameLocal: 'कोळसा बंदर', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_09', name: 'Reay Road', nameLocal: 'रे रोड', type: 'underground', isInterchange: true, interchangeWith: ['rail'], landmark: '', zone: 4 },
                { id: 'm11_10', name: 'Byculla', nameLocal: 'भायखळा', type: 'underground', isInterchange: true, interchangeWith: ['rail'], landmark: '', zone: 4 },
                { id: 'm11_11', name: 'Nagpada Junction', nameLocal: 'नागपाडा जंक्शन', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_12', name: 'Bhendi Bazaar', nameLocal: 'भेंडी बाजार', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_13', name: 'Crawford Market', nameLocal: 'क्रॉफर्ड मार्केट', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_14', name: 'CSMT', nameLocal: 'छत्रपती शिवाजी महाराज टर्मिनस', type: 'underground', isInterchange: true, interchangeWith: ['aqua', 'rail'], landmark: '', zone: 4 },
                { id: 'm11_15', name: 'Horniman Circle', nameLocal: 'हॉर्निमन सर्कल', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 },
                { id: 'm11_16', name: 'GPO', nameLocal: 'जीपीओ', type: 'underground', isInterchange: false, interchangeWith: [], landmark: '', zone: 4 }
            ]
        },
        {
            id: 'gold',
            name: 'Line 8 (Gold / Airport Express)',
            color: '#FFC107',
            colorLight: '#FFE082',
            corridor: '8',
            length: '32.0 km',
            ...
            stations: [
                { id: 'm3_05', name: 'CSMIA T2', nameLocal: 'छत्रपती शिवाजी महाराज आंतरराष्ट्रीय विमानतळ टी२', type: 'underground', isInterchange: true, interchangeWith: ['aqua'], landmark: 'Airport 1', zone: 4 },
                { id: 'm8_02', name: 'Mankhurd', nameLocal: 'मानखुर्द', type: 'elevated', isInterchange: true, interchangeWith: ['yellow-b'], landmark: '', zone: 3 },
                { id: 'm8_03', name: 'Vashi', nameLocal: 'वाशी', type: 'elevated', isInterchange: true, interchangeWith: ['rail'], landmark: '', zone: 1 },
                { id: 'm8_04', name: 'Ghansoli', nameLocal: 'घणसोली', type: 'elevated', isInterchange: true, interchangeWith: ['rail'], landmark: '', zone: 1 },
                { id: 'm8_05', name: 'Kopar Khairane', nameLocal: 'कोपरखैरणे', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm8_06', name: 'Turbhe', nameLocal: 'तुर्भे', type: 'elevated', isInterchange: true, interchangeWith: ['rail'], zone: 1 },
                { id: 'm8_07', name: 'Kharghar', nameLocal: 'खारघर', type: 'elevated', isInterchange: true, interchangeWith: ['rail'], landmark: '', zone: 1 },
                { id: 'm8_08', name: 'NMIA', nameLocal: 'नवी मुंबई आंतरराष्ट्रीय विमानतळ', type: 'elevated', isInterchange: false, landmark: 'Navi Mumbai Airport', zone: 1 }
            ]
        },
        {
            id: 'orange-12',
            name: 'Line 12 (Orange Ext.)',
            color: '#FF9800',
            colorLight: '#FFCC80',
            corridor: '12',
            length: '21.0 km',
            ...
            stations: [
                { id: 'm5_16', name: 'Kalyan Railway Station', nameLocal: 'कल्याण रेल्वे स्थानक', type: 'elevated', isInterchange: true, interchangeWith: ['orange'], landmark: '', zone: 1 },
                { id: 'm12_02', name: 'Siddharth Nagar', nameLocal: 'सिद्धार्थ नगर', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm12_03', name: '10th Adarsh Nagar', nameLocal: '१० वी आदर्श नगर', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm12_04', name: 'Golavali', nameLocal: 'गोळवली', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm12_05', name: 'Dombivli MIDC', nameLocal: 'डोंबिवली एमआयडीसी', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm12_06', name: 'Sagaon', nameLocal: 'सागाव', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm12_07', name: 'Nilje Gaon', nameLocal: 'निळजे गाव', type: 'elevated', isInterchange: false, interchangeWith: [], zone: 1 },
                { id: 'm12_08', name: 'Taloja', nameLocal: 'तळोजा', type: 'elevated', isInterchange: true, interchangeWith: ['nmm-1'], landmark: 'Navi Mumbai Connect', zone: 1 }
            ]
        },
        {
            id: 'red-9',
