...
const greenInterchanges = {
    'Esplanade': ['blue', 'purple']
};

const purpleInterchanges = {
    'Park Street': ['blue'],
...
const kolkataMetro = {
    ...
    lines: [
        ...
        },
        {
            ...
            status: 'operational',
            stations: purpleLineStations.map((s, i) => createStation('p', i, s, purpleInterchanges))
        },
        {
            id: 'orange',
            name: 'Orange Line',
...
const kolkataMetro = ${JSON.stringify(kolkataMetro, null, 4).replace(/"([^"]+)":/g, '$1:')};
